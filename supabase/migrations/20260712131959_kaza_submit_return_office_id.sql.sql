-- ─── Update submit_form_by_token to also return office_id + log id ─────────
-- The DigitalTokenReceipt needs office_id to subscribe to realtime queue updates
-- and the client_log id to track the user's own status.
...
BEGIN
  ...
  RETURN json_build_object(
    ...
    'office_id', v_log.office_id,
    'client_log_id', v_log.id,
